...
Before you proceed, make sure that (a) your terminal is currently operating inside the `phenotypic-characterization` folder or that you pass amiga.py with the full command (e.g. `/Users/firasmidani/phenotypic-characterization/amiga.py`), and (b) if you would like to use a virtual environment, make sure that you have activated it. 
